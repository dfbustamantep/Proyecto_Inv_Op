...
class SimplexApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Método Simplex - Dos Fases")

        # --- Entrada de la función objetivo ---
        frame_obj = ttk.LabelFrame(root, text="Función Objetivo (ej: 4x1 + 1x2)")
        ...
        frame_rest = ttk.LabelFrame(root, text="Restricciones (una por línea, ej: 3x1 + 1x2 >= 3)")
        ...
        frame_objetivo = ttk.LabelFrame(root, text="Tipo de Optimización")
        ...
        # --- Botón de ejecución ---
        self.btn_start = ttk.Button(root, text="Ejecutar Simplex", command=self.ejecutar_simplex)
